...
async function main() {
  ...
  const mockJobsData = [
    ...
    // Diverse multi-industry jobs (FNB, SPA, MECHANIC)
    {
      title: "Tuyển thợ cắt tóc nam/nữ",
      description: "Thực hiện cắt tạo kiểu, uốn nhuộm phục vụ khách hàng nam nữ. Có kỹ năng tư vấn chăm sóc tóc.",
      salary: "8.000.000đ - 12.000.000đ + % Doanh số",
      companyName: "Hair Salon Bông Sen",
      niche: "SPA",
      latitude: 10.7725,
      longitude: 106.6934,
      ai_tags: "hair-cut, hair-style, beauty, styling",
    },
    {
      title: "Nhân viên phục vụ Cafe",
      description: "Đón tiếp khách hàng, bưng bê phục vụ cà phê nước uống, lau dọn vệ sinh quán luôn gọn gàng sạch sẽ.",
      salary: "4.500.000đ - 6.000.000đ",
      companyName: "Cafe Miệt Vườn",
      niche: "FNB",
      latitude: 21.0333,
      longitude: 105.8555,
      ai_tags: "coffee-shop, waiter, waitress, hospitality",
    },
    {
      title: "Thợ phụ Spa/Nail",
      description: "Hỗ trợ thợ chính chăm sóc da mặt, chà gót chân, sơn sửa móng cơ bản cho khách hàng.",
      salary: "6.000.000đ - 9.000.000đ",
      companyName: "Tiệm Nail Bông Sen",
      niche: "SPA",
      latitude: 10.7791,
      longitude: 106.6922,
      ai_tags: "nail-art, manicure, spa-assistant, skincare",
    },
    {
      title: "Kỹ sư giám sát xây dựng",
      description: "Giám sát thi công kết cấu cốt thép, đổ bê tông tại công trường. Báo cáo tiến độ hàng ngày cho quản lý.",
      salary: "15.000.000đ - 22.000.000đ",
      companyName: "Xây dựng Hòa Bình",
      niche: "MECHANIC",
      latitude: 21.0267,
      longitude: 105.8488,
      ai_tags: "civil-engineering, site-survey, supervision, safety",
    },
    {
      title: "Thợ sửa xe máy/ô tô",
      description: "Kiểm tra động cơ, bảo dưỡng máy móc, thay phanh và sửa chữa sự cố truyền động xe ga xe số và xe hơi.",
      salary: "11.000.000đ - 16.000.000đ",
      companyName: "Gara Ô tô Tuấn Phát",
      niche: "MECHANIC",
      latitude: 10.7749,
      longitude: 106.7058,
      ai_tags: "car-repair, mechanic, motorcycle, engine-tuning",
    },
  ];
